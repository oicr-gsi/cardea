...
public class CaseStatusesForRun {
  ...
  public CaseStatusesForRun(
      Set<String> activeCases, Set<String> completedCases, Set<String> stoppedCases) {
    this.activeCases = activeCases == null ? Collections.emptySet() : unmodifiableSet(activeCases);
    this.completedCases =
        completedCases == null ? Collections.emptySet() : unmodifiableSet(completedCases);
    this.stoppedCases =
        stoppedCases == null ? Collections.emptySet() : unmodifiableSet(stoppedCases);
  }
